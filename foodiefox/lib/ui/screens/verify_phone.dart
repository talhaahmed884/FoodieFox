                          ...
                          children:<Widget> [
                            ...
                            GestureDetector(
                              onTap: () async{
                                ...
                                PhoneAuthCredential phoneAuthCredential = PhoneAuthProvider.credential ( smsCode: code, verificationId: verificationId_resend);
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: (){
                          ...
                          PhoneAuthCredential phoneAuthCredential = PhoneAuthProvider.credential ( smsCode: code, verificationId: widget.verificationId);
                          signInWithPhoneAuthCredential(phoneAuthCredential);
                                                  },
                                                  child: Container(
                                                    decoration: BoxDecoration(
