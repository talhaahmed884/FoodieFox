                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        placesWidget("food1", "Kabli Pulao"),
                        SizedBox(
                          height: 20,
                        ),
                        Row(
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              dishWidget("sushi", "Chicken Karhai",
                                  "5 Full serves 4 people, half is best for 2 peoples"),
                              dishWidget("suchi2", "Burgers and Fries",
                                  "5 Beef burger with fries for one person"),
                              dishWidget("sushi3", "Karachi Biryani",
                                  "5 Spicy biryani serves 2 people"),
                              dishWidget("sushi4", "Tikka Boti",
                                  "5 BBQ best for 2 people"),
                            ],
                          ),
                        )
                      ],
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: ColorVariety1.withOpacity(0.7)),
                      )
                    ],
                  )
                ],
