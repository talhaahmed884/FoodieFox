...
import '../home/components/foxpick_card.dart';
            ...
            Column(
              children: <Widget>[
                Align(
                  ...
                  child: Container(
                    margin:
                        EdgeInsets.only(top: 0, left: 22, bottom: 0, right: 0),
                    child: Text(
                      "Hi, Rafay",
                      style: TextStyle(
                ...
                Align(
                  ...
                  child: Container(
                    margin:
                        EdgeInsets.only(top: 10, left: 22, bottom: 0, right: 0),
                    child: Text(
                      "Where do you want\nto hangout today?",
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                    ...
                    child: Row(
                      children: [
                        for (int index = demoRestaurants.length - 1;
                            index > demoRestaurants.length - 3;
                            index--)
                          InkWell(
                            onTap: () => openMenuPage(demoRestaurants[index]),
                            child: Cards(
