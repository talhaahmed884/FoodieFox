...
import 'package:foodiefox_customer/ui/checkout/checkout_screen.dart';
import 'package:foodiefox_customer/ui/components/constants.dart';
import 'package:foodiefox_customer/ui/models/Data.dart';
import 'package:foodiefox_customer/ui/details/detailsPage.dart';
import 'package:foodiefox_customer/ui/reviews/reviews_page.dart';
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        var restaurantDoc = await restaurantDb
                            .where('Name',
                                isEqualTo: widget.restaurant.restaurant_name)
                            .get();
                        var currentRestaurantReference =
                            restaurantDb.doc(restaurantDoc.docs[0].id);
                        Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => ReviewsPage(
                                    restaurant: widget.restaurant,
                                    currentRestaurantReference:
                                        currentRestaurantReference,
                                  )),
                        );
                      },
