...
import 'package:foodiefox/ui/screens/reviews/review.dart';
import 'package:foodiefox/ui/screens/reviews/review_form.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ReviewForm(restaurant: this.restaurant)
            ),
          );
        },
      ),
  ...
  Widget _body(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('reviews').where(
          'restaurant_reference', isEqualTo: restaurant.reference
      ).snapshots(),
